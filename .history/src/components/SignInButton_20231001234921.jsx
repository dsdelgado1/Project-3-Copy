...
export const SignInButton = () => {
    ...
    const backgroundImage = url(/path/to/your/image.jpg)'  // Update this with the path to your image

    return (
        <div style={{ backgroundImage, height: '18vh', backgroundSize: 'cover', backgroundPosition: 'center' }}>
