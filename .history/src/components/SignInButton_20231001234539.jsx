...
export const SignInButton = () => {
    ...
    const backgroundImage = 'url(<div className=""></div>/logo.svg)';  // Update this with the path to your image

    return (
        <div style={{ backgroundImage, height: '30vh', backgroundSize: 'cover', backgroundPosition: 'center' }}>
