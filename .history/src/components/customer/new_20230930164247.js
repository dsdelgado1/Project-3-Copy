...
import { createCustomer, setNotification } from '../../actions/customer.js';
import { useNavigate } from 'react-router-dom';
import { setNotification } from '../../actions/customer.js';
...
*/
    ...
    useEffect(() => {
        if (hasBeenRenderedRef.current === true && Object.keys(errors).length === 0) {
            dispatch(setNotification("Customer Successfully Submitted"));
