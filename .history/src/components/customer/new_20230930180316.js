...
const New = () => {
    ...
    const hasBeenRenderedRef = useRef(true); //Used to determine if we've rendered it yet or not so that we don't have to run second useEffect at first render
...
*/
    ...
    const handleSubmit =  (e) => {
        ...
        try {
            const response =  dispatch(createCustomer(customer, selected));
