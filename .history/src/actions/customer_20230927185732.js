...
export const getCustomers = () => dispatch => {
  ...
  axios.get("https://crmpilot0-crmpilot0copy2.azurewebsites.net/customers")
...
export const createCustomer = (customer_information, selected_workers) => dispatch => {
  //Does exactly what it says it does
  axios.post("https://crmpilot0-crmpilot0copy2.azurewebsites.net/customers", { customer: customer_information, workers: selected_workers })
    .then(response => {
...
export const updateNotes = (note_data) => dispatch => {
  ...
  axios.post(`https://crmpilot0-crmpilot0copy2.azurewebsites.net/customers/update`, { value: note_data.value, id: note_data.id })
}
...
export const destroyCustomer = (customer_id) => dispatch => {
  ...
  axios.post(`https://crmpilot0-crmpilot0copy2.azurewebsites.net/customers/destroy`, { id: customer_id })
    .then(() => {
